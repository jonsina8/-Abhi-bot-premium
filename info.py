...
PICS = (environ.get('PICS', 'https://graph.org/file/d501fecf1e0fbc57a1219-78237a1c89e0b43ab7.jpg')).split() #SAMPLE PIC
...
CODE = (environ.get('CODE', 'https://t.me/movies_updet'))
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002520793005')
