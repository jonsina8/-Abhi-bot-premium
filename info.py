...
CODE = (environ.get('CODE', 'https://t.me/+azl1XsWi1Bk0NThl'))
...
STREAMHTO = (environ.get('STREAMHTO', 'https://t.me/+azl1XsWi1Bk0NThl'))

# Admins, Channels & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1807927334 7436687322').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002346311796').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://kari41875:ULpuG17sXjXV0Yna@cluster0.olegt6m.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/+azl1XsWi1Bk0NThl')
